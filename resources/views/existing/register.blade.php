    ...
    <div class="steps-registration">
        ...
        <div class="col-lg-12">
            <div class="card ">
                ...
                <form id="msform" method="POST" action="{{ route('migrate.post',$id) }}" enctype="multipart/form-data">
                    ...
                    <fieldset id="basicinfoSection">
                        ...
                        <input type="button" id="btnBasicInfo" name="next" class="next action-button" value="Next" /> 
                        <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    <fieldset id="empinfoSection">
                        @include('auth.register.employement')
                        <input type="button" id="btnEmpInfo" name="next" class="next action-button" value="Next" /> <input
                    ...
                    <fieldset id="benifcatorSection">
                        ...
                        <input type="button" id="btnBenificial" name="next" class="next action-button" value="Next" /> <input
                        type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    ...
                    <fieldset id="bankparticularSection">
                        ...
                        <input type="button" id="btnBank" name="next" class="next action-button" value="Next" /> <input
                        type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    <fieldset id="otherdetailsSection">
                      @include('auth.register.otherInfo')
                        <input type="button" id="btnOther" name="next" class="next action-button" value="Next" /> <input
                        type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    ...
                    <fieldset id="finishSection">
                        <div class="form-card">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-3"> <img src="{{asset('storage/images/done.gif')}}" class="fit-image"> </div>
                            </div> <br><br>
                            <div class="row justify-content-center">
                                <div class="col-7 text-center">
                                    <h5 class="purple-text text-center">Please Wait... You will have to fill KYC forms shortly </h5>
                                </div>
                            </div>
                        </div>
                    </fieldset>
...
<div class="modal fade" id="mobileOTPModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <!-- Modal email -->
  <div class="modal fade" id="emailOTPModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
...
function emailOTP(){
    ...
    $('input').filter('.emailOTP').each(function() {
                ...
                if ($(this).next().val() === '' && isValid ){
                    ...
                    var data = {"email": email,"_token": "{{ csrf_token() }}"}; //data to send to server
                var dataType = "json"//expected datatype from server
                // $('#loader').show();
                    $.post({
...
var data = {"email": verify_email, "otp":otpVerify, "_token": "{{ csrf_token() }}"}; //data to send to server
        var dataType = "json"//expected datatype from server
...
// documents upload according to company type 
   ...
   $(".next").click(function () {
           ...
           if($(this).attr('id')==='btnBasicInfo'){
                    ...
                    alertify.error(`Invalid Email Address`);
                     ...
                     isValid=false;
                        ...
                        var email_temp = $('#email').val();
                         var data = {"email": email_temp,"_token": "{{ csrf_token() }}"}; //data to send to server
                          var dataType = "json"//expected datatype from server
                        //  let watchID = 0;
                          var request =   $.post({
                            ...
                            success: function(data){
                                ...
                                // alert(data.state);
                                 if(data.state ===false){
                                    isValid=false;   
                                   alertify.error(`Email Already Exists In NSB FBMC`);
            ...
            if($(this).attr('id')==='btnStatement'){
                isValid=true;
                    ...
                    }else if((current_fs.attr('id')==='empinfoSection' && ACtype=="Joint") || (current_fs.attr('id')==='empinfoSection' && ACtype=="Indivitual")){
                        next_fs = $(this).parent().next().next();
        ...
        $(".previous").click(function () {
            ...
            }else if((current_fs.attr('id')==='bankparticularSection' && ACtype=="Joint") || (current_fs.attr('id')==='bankparticularSection' && ACtype=="Indivitual")){
                previous_fs = $(this).parent().prev().prev();
            }else{
    ...
    $('#add_more').on('click', function(){
      ...
      var html ='<div id="append_no_'+i+'" class="animated bounceInLeft">'+
           ...
           '  <div class="col-md-4">'+
                ...
                '<input type="text" name="joint_name_initials[]" placeholder="Name by Intitials" class="form-control"/>'+
           '</div>'+
       '</div>'+
       '<div class="row">'+
           '<div class="col-md-6">'+         
                '<label class="fieldlabels">Address Line 1 :*</label>'+ 
                '<input type="text" name="joint_address_line_1[]" placeholder="Address Line 1" class="form-control"/>'+
           '</div>'+
           '<div class="col-md-6">'+
                '<label class="fieldlabels">Address Line 2 :*</label>'+ 
                '<input type="text" name="joint_address_line_2[]" placeholder="Address Line 2 " class="form-control"/>'+
           '</div>'+
       '</div>'+
       '<div class="row">'+
        '<div class="col-md-6">'+
                '<label class="fieldlabels">Address Line 3 :*</label>'+ 
                '<input type="text" name="joint_address_line_3[]" placeholder="Address Line 3 " class="form-control"/>'+
        '</div>'+
        '<div class="col-md-6">'+
     ...
     '<div class="row">'+
        ...
        '<div class="col-md-6">'+
                ...
                '<input type="text" name="joint_mobile[]"placeholder="mobile" class="form-control joint_mobile OTP"/>'+
                '<input type="hidden" value="">'+
        '</div>'+
     '</div>'+ 
        '<div class ="joint_nic_div" >'+
            '<div class="row">'+
                '<div class="col-md-6">'+
                        ...
                        '<img id="joint_nic_front" src="'+"{{asset('storage/images/nic_front_preview.jpg')}}"+'" class="img_preview" />'+
                '</div>'+ 
                '<div class="col-md-6">'+
                        '<label class="fieldlabels">NIC Back Side: *</label>'+ 
                        '<input type="file" name="joint_nic_back[]" accept="image/*" class="imgLoad">'+
                        '<img id="joint_nic_back_preview" src="'+"{{asset('storage/images/nic_back_preview.jpg')}}"+'" class="img_preview" />'+
                '</div>'+  
            '</div>'+   
        '</div>'+
        '<div class="joint_passport_div">'+
          '<div class="row">'+
             '<div class="col-md-6">'+
                     ...
                     '<img id="joint_passport_preview" src="'+"{{asset('storage/images/nic_back_preview.jpg')}}"+'" class="img_preview" />'+
             '</div>'+
            '</div>'+
        '</div>'+
        '<div class="row">'+
            '<div class="col-md-6">'+
                    ...
                    '<img id="joint_passport_preview" src="'+"{{asset('storage/images/signature_preview.png')}}"+'" class="img_preview" />'+
            '</div>'+
            '<div class="col-md-6">'+
                '<label class="fieldlabels">Profile picture </label>'+
                '<input type="file" id="joint_profile_pic[]" name="joint_pro_pic[]" accept="image/*"  class="imgLoad">'+
