...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="name"placeholder="" id="name" value="{{$client->customer_name}}" class="fieldRequired" />
    </div>
    <div class="col-md-6">
...
<div>
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="email" id="email" name="email" placeholder="" value="{{$client->email}}" class="fieldRequired emailOTP" />
            <input type="hidden"  value="">
        </div>
        <div class="col-md-6">
            <label class="fieldlabels">NIC/Passport</label> 
            <input type="text" name="nic"placeholder=""  value="{{$client->nic}}" class="fieldRequired" />  
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        ...
        <input type="text"  name="address_line_1"  id="address_line_1" placeholder="" value="{{$client->address_line_1}}" class="fieldRequired" /> 
    </div>
    <div class="col-md-6">
        <label class="fieldlabels">Address Line 2</label>
        <input type="text" name="address_line_2" id="address_line_2" placeholder="" value="{{$client->address_line_2}}" class="fieldRequired" /> 
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <label class="fieldlabels">Address Line 3 (Optional) </label>
        <input type="text" name="address_line_3" id="address_line_3" value="{{$client->address_line_3}}" placeholder=""  /> 
    </div>
    <div class="col-md-6">
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <input type="number" maxlength="9" id="mobile" name="mobile" id="mobile" placeholder="77XXXXXXX (avoid first zero)"  value="{{$client->mobile}}" class="fieldRequired OTP"/>
        <input type="hidden"  value="">
    </div>
</div>       
