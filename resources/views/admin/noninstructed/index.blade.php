...
<div class="card">
    <div class="card-header">
     Non-Instructed Investment Records
    </div>
                ...
                <tbody>
                    ...
                    @foreach($investments as $key => $investment)
                        <tr data-entry-id="{{ $investment->id }}">
                            ...
                            <td>
                                {{$investment->value_date}} - {{$investment->maturity_date}}
                            </td>
                            <td>
                            ...
                            <td>
                                @can('client_approval_access')
                                    ...
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.noninstructed.show',$investment->id) }}">
                                        Proceed
                                     </a>
                                    @endif
