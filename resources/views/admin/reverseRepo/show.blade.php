    ...
    <div class="row">
            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <img src="{{asset('storage/uploads/'.$reverseRepo->client->pro_pic)}}" alt="" class="img-rounded img-responsive" width="50px" height="100px" />
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <p>
                            ...
                            {{-- <i class="fa fa-dollar"></i>@money($reverseRepo->investment->invested_amount)</p> --}}
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
           <form id="approvalForm" action="" method="POST"  enctype="multipart/form-data">
            @csrf
            <label for="">Available Balance @money($reverseRepo->investment->invested_amount)</label></br>
            @if ($reverseRepo->amount!=0)
            <label for="">Requested reverseRepo Amount @money($reverseRepo->amount)</label></br>
            @endif
            <label for="">{{$reverseRepo->investment->InvestmentType->name}}</label></br>
