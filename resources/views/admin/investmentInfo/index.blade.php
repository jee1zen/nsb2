                    ...
                    @foreach($investments as $key => $investment)
                        <tr data-entry-id="{{ $investment->id }}">
                            ...
                            <td>
                              ...
                              {{$investment->client->title ?? ""}} &nbsp; {{ $investment->client->name ?? '' }} <br>
                              ...
                              @if ($investment->client->hasJointHolders())
                                 ...
                                 @foreach ($investment->client->jointHolders()->get() as $jointHolder )
                                        ...
                                        {{$jointHolder->title}} &nbsp; {{$jointHolder->name}} (Joint Holder) <br>
                         ...
                         @endif
                            ...
                            <td>
                              <a href="{{route('admin.investment.info.client',$investment->client->id)}}" target="_blank" class="btn btn-primary btn-sm">Client</a> &nbsp;
                              <a  href="{{route('admin.investment.info.investment',[$investment->client->id,$investment->id])}}" target="_blank"class="btn btn-success btn-sm">Investment</a>&nbsp;
                              <a  href="{{route('admin.investment.info.kyc',[$investment->client->id,$investment->id])}}" target="_blank"  class="btn btn-warning btn-sm">KYC</a>
                              <a  href="{{route('admin.clients.dashboard',$investment->client->id)}}" target="_blank"  class="btn btn-xs btn-info">DBoard</a>
                            </td>
                            <td>
