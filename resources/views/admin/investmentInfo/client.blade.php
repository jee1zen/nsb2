                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{asset('/storage/uploads/'.$client->nic_front)}}" target="_blank"> 
                                <img src="{{asset('storage/uploads/'.$client->nic_front)}}" class="customImage"   alt="nic front">
                            </a>
                            @endif
                        </td>
                        <td>
                            ...
                            <a href="{{asset('/storage/uploads/'.$client->nic_back)}}" target="_blank"> 
                                <img src="{{asset('storage/uploads/'.$client->nic_back)}}" class="customImage"   alt="nic back">
                            </a>
                            @endif
                        </td>
                        <td>
                            ...
                            <a href="{{asset('/storage/uploads/'.$client->passport)}}" target="_blank"> 
                                <img src="{{asset('storage/uploads/'.$client->passport)}}" class="customImage"   alt="passport">
                            </a>
                            @endif
                        </td>
                        @if($client->signature!=null)
                            ...
                            <td>
                                ...
                                <a href="{{asset('/storage/uploads/'.$client->signature)}}" target="_blank"> 
                                    <img src="{{asset('storage/uploads/'.$client->signature)}}" class="customImage"  alt="signature">
                                </a>
                            </td>
                        ...
                        <h5>JointHolders</h5>
                         ...
                         <table class="table table-bordered  table-hover">
                             ...
                             @if ($jointHolder->nic_front!=null && $jointHolder->nic_front!='none')
                                ...
                                <td>  <strong> NIC Front</strong> <a href="{{asset('/storage/uploads/'.$jointHolder->nic_front)}}" target="_blank"> 
                                    <img src="{{asset('storage/uploads/'.$jointHolder->nic_front)}}"  class="customImage"  alt="Joint Holder NIC">
                                </a></td>
                             ...
                             @if ($jointHolder->nic_back!=null && $jointHolder->nic_back!='none')
                                ...
                                <td> <strong> NIC Back</strong> <a href="{{asset('/storage/uploads/'.$jointHolder->nic_back)}}" target="_blank"> 
                                    <img src="{{asset('storage/uploads/'.$jointHolder->nic_back)}}"  class="customImage"  alt="Joint Hold NIC BACK">
                                </a></td>
                             ...
                             @if ($jointHolder->passport!=null && $jointHolder->passport!='none')
                                ...
                                <td>  <strong> Passport</strong><a href="{{asset('/storage/uploads/'.$jointHolder->passport)}}" target="_blank"> 
                                    <img src="{{asset('storage/uploads/'.$jointHolder->passport)}}"  class="customImage"  alt="Passport">
                                </a></td>
                             ...
                             @if ($jointHolder->signature!=null)
                                ...
                                <td>  <strong> Signature</strong><a href="{{asset('/storage/uploads/'.$jointHolder->signature)}}" target="_blank"> 
                                    <img src="{{asset('storage/uploads/'.$jointHolder->signature)}}"  class="customImage"  alt="Signature">
                                </a></td>
                     ...
                     <tr>
                         ...
                         <td>
                             ...
                             <table class="table table-bordered  table-hover no-print" >
                                 ...
                                 <tr >
                                     <td>
                                         <a href="{{asset('storage/uploads/'.$upload->file_name)}}" target="_blank">{{$upload->title!=""?$upload->title:$upload->file_name}}</a>
                                     </td>
