                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        ...
                        <form id="approvalForm" action="" method="POST" action ="" enctype="multipart/form-data">
                            @csrf
                        @if (($officer_role->id==5 && $investment->status==0) ||($officer_role->id==6 && $investment->status == 0)  || ($officer_role->id==7 && $investment->status==1))
                              ...
                              <tbody>
                                <th>
                                  ...
                                  <td>
                                    <select name="investment_type" id="investment_type" class="form-control">
                                        ...
                                        <option value="{{$type->id}}" {{$investment->investment_type_id==$type->id ? "Selected" : "" }} >{{$type->name}}</option>
                                  ...
                                  <tr>
                                    <input type="hidden" name="investment_id" value="{{$investment->id}}">
                                      ...
                                      <td>
                                         <input type="text"  name="amount"  data-type="currency" value="{{$investment->amount}}" class="form-control">
                                      </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td>
                                        <div class="input-group">  
                                         <input type="text"  name="yield" value="{{$investment->yield}}"   class="form-control">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" value="{{Carbon::createFromFormat('Y-m-d', $investment->value_date)->diffInDays( Carbon::createFromFormat('Y-m-d', $investment->maturity_date))}}" class="form-control" disabled>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="instruction" id="instuction" class="form-control">
                                            <option value="" {{$investment->instruction== "" ?'':''}}>Reinvest principal with interest</option>
                                            <option value="Reinvest principal with interest" {{$investment->instruction== "Reinvest principal with interest" ?'selected':''}}>Reinvest principal with interest</option>
                                            <option value="Reinvest principal without interest" {{$investment->instruction== "Reinvest principal without interest" ?'selected':''}}>Reinvest principal without interest</option>
                                            <option value="Reinvest the same Face Value & Pay the upfront interest" {{$investment->instruction== "Reinvest the same Face Value & Pay the upfront interest" ?'selected':''}}>Reinvest the same Face Value & Pay the upfront interest</option>
                                            <option value="Do not reinvest" {{$investment->instruction== "Do not reinvest" ?'selected':''}}>Do not reinvest</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
