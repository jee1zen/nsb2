                ...
                <div class="card ">
                    ...
                    <div id="msform">
                        ...
                        <ul id="progressbar">
                            ...
                            <li id="employment" class="active"><strong>Employment Info</strong></li>
                        ...
                        <fieldset id="empinfoSection">
                            <form id="basicInfoForm" method="POST"
                                action="{{ route('client.changeAccountEmpInfo', $account->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @include('auth.register.employmentChange')
                                <input type="submit" id="btnEmpInfo" name="next" class="next action-button"
                                    value="Next" />
                                <a name="previous" class="previous action-button-previous"
                                    href="{{ route('client.changeAccountBasicInfo', $account->id) }}">Back</a>
                            </form>
