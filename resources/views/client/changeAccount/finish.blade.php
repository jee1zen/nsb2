        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h2 id="heading">NSB FMC Account Changing Completed</h2>
                            <p></p>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div id="msform">
                        ...
                        <fieldset id="finishSection">
                            <div class="form-card">
                                <div class="row">
                                    <div class="col-7">
                                        <h2 class="fs-title">Changing:</h2>
                                    </div>
                                    <div class="col-5">
                                        <h2 class="steps">Done</h2>
                                    </div>
                                </div> <br><br>
                                <h2 class="purple-text text-center"><strong>Your Changes in NSB Account information
                                        submitted and Under
