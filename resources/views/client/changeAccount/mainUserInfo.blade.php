                ...
                <div class="card ">
                    ...
                    <div id="msform">
                        ...
                        <ul id="progressbar">
                            ...
                            <li id="basic" class="active"><strong>Basic Info</strong></li>
                        ...
                        <fieldset id="basicinfoSection">
                            ...
                            <div class="form-card">
                                <form id="basicInfoForm" method="POST"
                                    action="{{ route('client.changeAccountBasicInfo', $account->id) }}"
                                    enctype="multipart/form-data">
                                    @csrf

                                    @include('auth.register.mainUserInfo')
                                    @include('auth.register.jointHoldersWithChangeData')
                            ...
                            <a name="previous" class="previous action-button-previous"
                                href="{{ route('client.changeAccountStaging', $account->id) }}">Back</a>

                        </fieldset>
                        <div class="row justify-content-center">
                            <div class="col-7 text-center">
                                <a href="{{ route('client.dashboard') }}">
                                    <h5 class="purple-text text-center">Go Back To DashBoard </h5>
                                </a>
                            </div>
                        </div>
                    </div>
