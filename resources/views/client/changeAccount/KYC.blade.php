        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h2 id="heading">Changing Account</h2>
                            <p>Update nessary fields and to go to next step</p>
                            <p>Changes will be submitted to NSB Team once you finish the full process</p>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div id="msform">
                        ...
                        <ul id="progressbar">
                            ...
                            <li id="KYC" class="active"><strong>KYC</strong></li>
                        ...
                        <fieldset id="kycSection">
                            <form id="accTypeForm" method="POST"
                                action="{{ route('client.changeAccountKyc', $account->id) }}" enctype="multipart/form-data">
                                @csrf
                                @include('auth.register.KYC')
                                <input type="submit" id="btnKYC" name="next" class="next action-button"
                                    value="Next" />
                                <a name="previous" class="previous action-button-previous"
                                    href="{{ route('client.changeAccountOtherInfo', $account->id) }}">Back</a>
                            </form>
                        </fieldset>
        ...
        $(document).ready(function() {
            ...
            if ("{{ $kyc }}" !== null) {
                ...
                if ("{{ $kyc->kyc_employment_status ?? '' }}" === "Other") {
                    $('#kyc_other_employement').val("{{ $kyc->kyc_other_employment ?? '' }}")
