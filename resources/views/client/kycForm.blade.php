        ...
        <div class="col-md-8 bg-light bg-gradient text-dark bg-opacity-60">
            ...
            <form id="msform" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-card" id="kyc">
                    ...
                    <input type="text" id="kyc_name" name="kyc_name" placeholder="" value="{{ $client->name }}"
                    ...
                    <input type="text" id="kyc_nic" name="kyc_nic" placeholder="" value="{{ $client->nic }}"
                    ...
                    <div class="form-group">
                        <label for="kyc_account_at_NSB_FMC" class="form-label">Do you have an investment account at NSB FMC
                            : *</label>

                        <select name="kyc_account_at_NSB_FMC" id="kyc_account_at_NSB_FMC"
                            class="form-control {{ $errors->has('kyc_account_at_NSB_FMC') ? 'is-invalid' : '' }}"
                            aria-describedby="kyc_account_at_NSB_FMC_feedback" required>
                            <option value="">Select</option>
                            <option value="No">No</option>
                            <option value="Yes">Yes</option>
                        </select>
                        @if ($errors->has('kyc_account_at_NSB_FMC'))
                            <div id="kyc_account_at_NSB_FMC_feedback" class="invalid-feedback">
                    ...
                    <div id="kyc_nature_of_business_specify_DIV">
                        ...
                        <input type="text" id="kyc_nature_of_business_specify" name="kyc_nature_of_business_specify"
                            placeholder="" value="{{ $client->employmentDetails->nature }}"
                    ...
                    <input type="text" id="kyc_employment" name="kyc_employment" placeholder=""
                        ...
                        class="fieldRequired {{ $errors->has('kyc_employment') ? ' is-invalid' : '' }}" />
                    ...
                    <textarea type="text" id="kyc_employer_address" name="kyc_employer_address" placeholder=""
                        class="fieldRequired {{ $errors->has('kyc_employment') ? ' is-invalid' : '' }}">{{ $client->employmentDetails->company_name }}
{{ $client->employmentDetails->company_address }}
                    ...
                    <textarea type="text" id="kyc_permanent_address" name="kyc_permanent_address" placeholder=""
                        class="fieldRequired {{ $errors->has('kyc_permanent_address') ? ' is-invalid' : '' }}">{{ $client->address_line_1 }}
...
{{ $client->address_line_3 }}
                    ...
                    <textarea type="text" id="kyc_foreign_address " name="kyc_foreign_address" placeholder=""
                        class="{{ $errors->has('kyc_foreign_address') ? ' is-invalid' : '' }}"></textarea>
                    ...
                    <input type="text" id="kyc_country_of_residence" name="kyc_country_of_residence" placeholder=""
                        class="fieldRequired {{ $errors->has('kyc_country_of_residence') ? ' is-invalid' : '' }}" />
                    ...
                    <select name="kyc_purpose_of_opening_account" id="kyc_purpose_of_opening_account"
                        class="form-controlfield{{ $errors->has('kyc_purpose_of_opening_account') ? ' is-invalid' : '' }}"
                        required>
                        <option value="">Select</option>
                    ...
                    <select name="kyc_source_of_funds" id="kyc_source_of_funds"
                        class="{{ $errors->has('kyc_source_of_funds') ? ' is-invalid' : '' }}" required>
                        <option value="">Select</option>
                    ...
                    <select name="kyc_anticipated_volume" id="kyc_anticipated_volume"
                        class="form-control{{ $errors->has('kyc_anticipated_volume') ? ' is-invalid' : '' }}" required>
                        <option value="">Select</option>
                    ...
                    <select name="kyc_expected_mode_of_transacation" id="kyc_expected_mode_of_transacation"
                        class="form-control{{ $errors->has('kyc_expected_mode_of_transacation') ? ' is-invalid' : '' }}"
                        required>
                        <option value="">Select</option>
