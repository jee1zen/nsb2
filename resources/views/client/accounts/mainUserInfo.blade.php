                        ...
                        <fieldset id="basicinfoSection">
                            ...
                            <div class="form-card">
                                <form id="basicInfoForm" method="POST"
                                    action="{{ route('client.newAccountBasicInfo', $account->id) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    @if ($account->type == 2 && $client == null)
                                        @include('auth.register.jointHolder')
                                    @elseif ($account->type == 2 && !$client->hasJointHoldersWithAccount($account->id))
                                        @include('auth.register.jointHolder')
                                    @elseif ($account->type == 2 && $client->hasJointHoldersWithAccount($account->id))
                            ...
                            <a name="previous" class="previous action-button-previous"
                                href="{{ route('client.newAccountAccountType', $account->id) }}">Back</a>
                        </fieldset>
