                        ...
                        @include('client.accounts.common.sectionProgress')
                            <fieldset id="bankparticularSection">
                                ...
                                <a id="btnBank" name="next" class="next action-button" value="Next"
                                    href="{{ route('client.newAccountOtherInfo',$account_id) }}">Next</a>
                                <a name="previous" class="previous action-button-previous"
                                    href="{{ route('client.newAccountEmpInfo',$account_id) }}">Back</a>
                            </fieldset>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formParticularSubmit" method="POST" action="{{ route('client.newAccountBank.save',$account_id) }}"
