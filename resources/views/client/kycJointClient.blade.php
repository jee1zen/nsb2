        ...
        <div class="card mx-4">
            <div class="card-body p-4">
                ...
                <p>
                    ...
                    In order to proceed for verification process you need to fill the NSB KYC Form for you as you are a joint holder of an upcoming  investment.
                </p>
              ...
              @endif
                ...
                @if (!$jointHolder->hasKyc())
                 ...
                 <div id="kycDIV"  style="margin-bottom:10px;">
                    <a class="btn btn-primary btn-lg" id="btnKyc" href="{{route('client.kyc.joint',[$jointHolder->id,$investment_id])}}"> Fill {{$jointHolder->name}} 's KYC FORM</a> <br>
                 </div>
