        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h2 id="heading">Register For An Account in NSB FM - Bank Particulars</h2>
                            <p>Add Bank Particulars and to go to next step</p>
                        </div>
                        <div class="col-md-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formParticularSubmit" method="POST" action="{{ route('registration.bank') }}"
