                ...
                <div class="card ">
                    ...
                    <div id="msform">
                        ...
                        <fieldset id="basicinfoSection">
                            <div class="form-card">
                                <form id="basicInfoForm" method="POST" action="{{ route('client.resetAccountBasicInfo.save',$account_id) }}"
                                    ...
                                    <a name="previous" class="previous action-button-previous"
                                        href="{{ route('client.reset.index',$account_id) }}">Back</a>
                                </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            function submitForm(formId) {
                ...
                $.ajax({
                    url: "{{ route('client.resetAccountBasicInfo.save',$account_id) }}", // Replace with your actual route
                    method: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        if (accountType == 2) {
                            window.location.href = "{{ route('client.resetAccountJointInfo',$account_id) }}";
                        } else {
                            window.location.href = "{{ route('client.resetAccountEmpInfo',$account_id) }}";
                        }
                    },
