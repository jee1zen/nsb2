                 ...
                 <tr>
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        {{$reverseRepo->investment->InvestmentType->name}} - @money($reverseRepo->investment->invested_amount) - Matured -  {{$reverseRepo->investment->maturity_date}}
                      </td>
                  </tr>
                  <tr>
                      <th>
                  ...
                  <tr>
                          ...
                          <td>
                              ...
                              <form class="approvalForm" method="POST" action ="{{route('client.reverseRepo.process')}}" enctype="multipart/form-data">
                                  @csrf
...
<script>
       $(function () {
        ...
        $('.btnApprove').click(function(){
            ...
            alertify.confirm('Client Approval', 'Are you sure you want to Approve ReverseRepo Request  For further process?', function(){ 
