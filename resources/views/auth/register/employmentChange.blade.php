        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" name="emp_company_address" placeholder="" class=""
                    value="{{ $employmentDetails->company_address ?? '' }}" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" name="emp_nature" placeholder="" class=""
                    value="{{ $employmentDetails->nature ?? '' }}" />
            </div>
        </div>
    </div>
    ...
    @if (!empty($jointHolders))
        ...
        <div id="jointEmpInfoDIV">
            <div id="dynamic_emp">
                ...
                @foreach ($jointHolders as $key => $jointHolder)
