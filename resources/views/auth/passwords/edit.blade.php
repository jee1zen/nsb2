    ...
    <div class="card-body">
        <form method="POST" action="{{ route("profile.password.update") }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="new_password" id="password" required>
                @if($errors->has('password'))
                    <div class="invalid-feedback">
                        {{ $errors->first('password') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="password" name="password_confirmation" id="new_password_confirmation" required>
            </div>
            <div class="form-group">
