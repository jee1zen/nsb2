    ...
    <table width="100%" style="float:right; margin-top:-35px !important; margin-left:-25px;">
          <tr>
            ...
            <td style="text-align: right;  padding-bottom: 0px">
              <img  src="{{public_path("storage/images/certificate_head_logo.png")}}" alt="" style="width:200px; height: 70px; margin-bottom:0px; margin-top:0px;">
            </td>
          </tr>
          <tr>
            <td></td>
          ...
          <tr>
            <td colspan="2"  style="font-size: x-small; text-align: right">No 400, Galle Road, Colombo 03. Telephone: 2425010 Fax: 2574387 Email nsbfmc@nsb.lk</td>
          </tr>
        </table>
        ...
        <hr class="solid">
         <table class="table_data">
              ...
              <div class="clearfix"></div>
        <hr class="solid">
          <h5> <u> Purchase Of Treasury Bonds</u></h5>
        ...
        <ul style="padding-left: 0;">
          ...
          <li style="font-size:x-small;">Investor/s agrees to provide instructions pertaining to maturity proceeds at least seven (07) calendar days prior to maturity. In the event of such instruction not being received, the Company may reinvest such proceeds for a period not exceeding the period of the earlier transaction, in accordance with the Customer Charter</li>
          <li  style="font-size:x-small;">Investor/s shall immediately notify the Company of any changes to existing operating instructions along with required supporting documentation.</li>
          <li  style="font-size:x-small;">Investor/s shall inform the Company of any discrepancy on a transaction relating to investments within 14 working days of such transaction.</li>
          <li  style="font-size:x-small;"> Investor/s needs to withdraw before maturity, the company will rediscount the instruments at the market rate + margin applicable at discount time subject to the company funding availability</li>

        </ul>
       <hr class="solid" style="margin-bottom: 0.5px!important">
        <p  class="text-center" style="font-size:x-small; margin-top: 1px;">* This is computer generated report and signature does not required *</p>
      </div>
    </body>
</html>
