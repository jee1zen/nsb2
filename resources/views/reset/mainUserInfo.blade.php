...
<div>
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="nic" placeholder="" class="fieldRequired" value="{{ $client->nic }}" />
        </div>
    </div>
</div>
        ...
        <div id="correspondanceCheck_DIV">
            <div class="form-check pull-left">
                <label class="form-check-label" style="margin-top: 2.7em">
                    <input class="form-check-input" type="checkbox" name="sameAsAddressCheck" id="sameAsAddressCheck"
...
<div id="corresponding_address_DIV">
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" name="corresponding_address_line_1" id="corresponding_address_line_1"
                placeholder="" class="" value="{{ $client->correspondence_address_line_1 }}" />
        </div>
        <div class="col-md-6">
            ...
            <input type="text" name="corresponding_address_line_2" id="corresponding_address_line_2"
                placeholder="" class="" value="{{ $client->correspondence_address_line_2 }}" />
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <label class="fieldlabels">Corresponding Address Line 3 (Optional) </label>
            <input type="text" name="corresponding_address_line_3" id="corresponding_address_line_3"
                placeholder="" value="{{ $client->correspondence_address_line_3 }}" />
        </div>
...
<div class="row">
    <div class="col-md-6">
        ...
        <input type="text" name="telephone" id="telephone" placeholder="" class="fieldRequired" />
    </div>
    <div class="col-md-6">
        <input type="hidden" name="full_mobile" value="{{ $client->mobile }}">
        <label class="fieldlabels">Mobile</label>
        <input type="tel" name="mobile" id="mobile" value="" class="fieldRequired OTP" />
        <input type="hidden" value="">
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div id="other_nationalityDIV">
            ...
            <input type="text" id="other_nationality" name="other_nationality" id="other_nationality"
                placeholder="">
        </div>
    </div>
</div>
