...
class CreateChangeRequestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('change_requests', function (Blueprint $table) {
            ...
            $table->boolean('title_state')->default(0);
            $table->boolean('name_state')->default(0);
            $table->boolean('address_state')->default(0);
            $table->boolean('correspondence_address_state')->default(0);
            $table->boolean('nic_state')->default(0);
