...
class CreateKYCCompanySignatureFormsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('k_y_c_company_signature_forms', function (Blueprint $table) {
            $table->bigInteger('id');
    ...
    {
        Schema::dropIfExists('k_y_c_company_signature_forms');
    }
}
